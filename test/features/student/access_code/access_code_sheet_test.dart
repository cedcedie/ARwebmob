...
void main() {
  testWidgets('submitting a valid code calls AccessCodeService.redeem with the given target and shows the result',
      (tester) async {
  ...
  testWidgets('an invalid code echoes the exact code typed and does not unlock anything', (tester) async {
    final firestore = FakeFirebaseFirestore();
    final studentRepo = StudentRepository(firestore: firestore);
    await studentRepo.saveStudent(_blankStudent('111111'));
    final accessCodeService = AccessCodeService(
