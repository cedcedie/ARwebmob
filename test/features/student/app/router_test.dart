...
void main() {
  ...
  testWidgets(
    ...
    await firestore.collection('lessons').doc('teacher-extra-2').set(const TeacherLesson(
      id: 'teacher-extra-2',
      title: 'Extra Credit: Earthquakes',
      subject: SubjectKey.physics,
      linkedQuizId: 'quiz-eq-1',
    ).toJson());
    await firestore.collection('quizzes').doc('quiz-eq-1').set(TeacherQuiz(
      id: 'quiz-eq-1',
  ...
  testWidgets(
    ...
    await firestore.collection('lessons').doc('teacher-extra-3').set(const TeacherLesson(
      id: 'teacher-extra-3',
