...
void main() {
  test(
    'item analysis over 10 real student attempts on a teacher-linked quiz: '
    ...
    'with total score show positive discrimination',
    () async {
      ...
      Future<void> recordFor(String studentId, {required bool q2Correct, required bool q3Correct}) async {
      ...
      expect(q0.difficultyIndex, closeTo(1.0, 0.0001), reason: 'every student answered Q0 correctly');
      expect(q1.difficultyIndex, closeTo(0.0, 0.0001), reason: 'no student answered Q1 correctly');
