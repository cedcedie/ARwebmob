...
void main() {
  testWidgets('shows the teacher placeholder on web, the sign-in gate on Android', (tester) async {
    await tester.pumpWidget(
      ProviderScope(
        // No student is signed in for this smoke test. Overriding this
        // provider (rather than relying on the real FirebaseAuth.instance
        ...
        overrides: [currentStudentIdProvider.overrideWith((ref) => Stream.value(null))],
